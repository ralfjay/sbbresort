...
<html lang="en">
  ...
  <body>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    ...
                    <li>
                      <a><?php echo e($checkindateDisplay); ?></a>
                    ...
                    <li>
                      <a><?php echo e($checkoutdateDisplay); ?></a>
                    </li>
                  </ul>
                </div>
                <div class="col-lg-6">
    ...
    <script type="text/javascript">
      ...
      {
         if(parseInt(<?php echo e($guest); ?>) > parseInt(cp) && parseInt(<?php echo e($guest); ?>) <= parseInt(tcp) && b == a )
          {
            $('#btn-submit').attr('disabled','true');
            swal({
              title: "Are you sure?",
              text: "You will have an extra charge of Php" + ((<?php echo e($guest); ?> - cp ) * 450) +"\n"+
              "("+(<?php echo e($guest); ?> - cp)+" extra person x 450)",
              icon: "warning",
              buttons: true,
              dangerMode: true,
            })
          ...
          }else if(parseInt(<?php echo e($guest); ?>) > parseInt(tcp))
          {
            swal('Room Capacity Validation',"We can't accommodate the given number of guests even with the inclusion of "+(tcp - cp)+" mattresses to all room selected. "+(<?php echo e($guest); ?> - tcp)+" excess guests.",'info')
            .then(willBack => {
              if(willBack)
              {
