...
<center>
	<div class="container">
			...
			<div class="row justify-content-center">
				<strong>
					<?php $__currentLoopData = $_resort_email; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resort_email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php echo e($resort_email->email); ?>
  ...
  <div class="pull-right">
    <h5>Date: <?php echo e(date('M d, Y')); ?></h5>
  </div>
<table class="tg" style="margin-top: 5%">
  <tr>
    <td class="tg-oczp">Booking Code: <?php echo e($_bookingdetails[0]->booking_code); ?></td>
     <td class="tg-oczp">Check in: <?php echo e($_bookingdetails[0]->checkin_date); ?></td>
  </tr>
  <tr>
  	<td class="tg-oczp">Name: <?php echo e($_bookingdetails[0]->last_name.', '.$_bookingdetails[0]->first_name); ?></td>
  	<td class="tg-oczp">Check out: <?php echo e($_bookingdetails[0]->checkout_date); ?></td>
  </tr>
  <tr>
  	 <td class="tg-oczp">Guest(s): <?php echo e($_bookingdetails[0]->no_of_guest); ?></td>
  	 <td class="tg-oczp">Night(s): <?php echo e($_bookingdetails[0]->total_nights); ?></td>
  </tr>
</table>
...
<table class="tg" style="margin-top: 5%;">
  ...
  <tr>
    <td class="tg-rg0h"><?php echo e($bookingdetails->roomqnt); ?></td>
    <td class="tg-rg0h"><?php echo e($bookingdetails->room_name); ?></td>
    <td class="tg-rg0h">&#x20B1;<?php echo e(number_format(($bookingdetails->rate * $bookingdetails->roomqnt * $_bookingdetails[0]->total_nights),2)); ?></td>
  </tr>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  <?php if($_bookingdetails[0]->extra_mattress != 0): ?>
  	<tr>
	  	<td class="tg-rg0h"><?php echo e($_bookingdetails[0]->extra_mattress); ?></td>
	    <td class="tg-rg0h">Extra Mattress</td>
	    <td class="tg-rg0h">&#x20B1;<?php echo e(number_format(($_bookingdetails[0]->extra_mattress_amount),2)); ?></td>
  	</tr>
  <?php endif; ?>
</table>
</center>
...
<table  style="margin-top: 2%;">
  <tr>
  	...
  	<td class="tg-rg0h">&nbsp;&nbsp;&nbsp;&nbsp;&#x20B1;<?php echo e(number_format($vat,2)); ?></td>
  </tr>
   <tr>
    <td class="tg-rg0h">VATable Amount: </td>
    <td class="tg-rg0h">&nbsp;&nbsp;&nbsp;&nbsp;&#x20B1;<?php echo e(number_format($vatable,2)); ?></td>
  </tr>
  <tr>
  	<td class="tg-rg0hb">Total Amount: </td>
  	<td class="tg-rg0hb">&nbsp;&nbsp;&nbsp;&nbsp;&#x20B1;<?php echo e(number_format($total_amount,2)); ?></td>
  </tr>
</table>
