  ...
  <html>
    ...
    <!-- END nav -->
      ...
      <section class="site-hero overlay" style="background-image: url(homepage_assets/images/hero_5.jpg)" data-stellar-background-ratio="0.5" id="section-home">
        <div class="container">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
              <img src="homepage_assets/images/hero_4.jpg" alt="Image" class="img-fluid rounded">
            </div>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(homepage_assets/images/person_3.jpg);">
                <div class="box">
                  <h2>Will Smith</h2>
                  <p>President</p>
                </div>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="homepage_assets/images/person_3.jpg" alt="">
                  </div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="block-2"> <!-- .hover -->
            <div class="flipper">
              <div class="front" style="background-image: url(homepage_assets/images/person_1.jpg);">
                <div class="box">
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="homepage_assets/images/person_1.jpg" alt="">
                  </div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
          <div class="block-2">
            <div class="flipper">
              <div class="front" style="background-image: url(homepage_assets/images/person_2.jpg);">
                <div class="box">
                  <h2>Jane Johnson</h2>
              ...
              <div class="back">
                ...
                <div class="author d-flex">
                  <div class="image mr-3 align-self-center">
                    <img src="homepage_assets/images/person_2.jpg" alt="">
                  </div>
    ...
    <!-- END .block-2 -->
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
              <a href="#" class="room">
                <figure class="img-wrap">
                  <img src="homepage_assets/images/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
                </figure>
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
              <a href="#" class="room">
                <figure class="img-wrap">
                  <img src="homepage_assets/images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
                </figure>
                <div class="p-3 text-center room-info">
                  <h2>Family Room</h2>
            ...
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
              <a href="#" class="room">
                <figure class="img-wrap">
                  <img src="homepage_assets/images/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
                </figure>
                <div class="p-3 text-center room-info">
            ...
            <div class="col-md-12">
              <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="slider-item">
                  <a href="homepage_assests/images/slider-1.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="homepage_assets/images/slider-1.jpg" alt="Image placeholder" class="img-fluid"></a>
                </div>
                <div class="slider-item">
                  <a href="homepage_assests/images/slider-2.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="homepage_assets/images/slider-2.jpg" alt="Image placeholder" class="img-fluid"></a>
                </div>
                <div class="slider-item">
                  <a href="homepage_assests/images/slider-3.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="homepage_assets/images/slider-3.jpg" alt="Image placeholder" class="img-fluid"></a>
                </div>
                <div class="slider-item">
                  <a href="homepage_assests/images/slider-4.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="homepage_assets/images/slider-4.jpg" alt="Image placeholder" class="img-fluid"></a>
                </div>
                <div class="slider-item">
                  <a href="homepage_assests/images/slider-5.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="homepage_assets/images/slider-5.jpg" alt="Image placeholder" class="img-fluid"></a>
                </div>
                <div class="slider-item">
                  <a href="homepage_assests/images/slider-6.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="homepage_assets/images/slider-6.jpg" alt="Image placeholder" class="img-fluid"></a>
                </div>
                <div class="slider-item">
                  <a href="homepage_assests/images/slider-7.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="homepage_assets/images/slider-7.jpg" alt="Image placeholder" class="img-fluid"></a>
                </div>
              </div>
              <!-- END slider -->
            </div>
      ...
      <section class="section bg-image overlay" style="background-image: url('homepage_assets/images/hero_3.jpg');" id="section-menus">
        <div class="container">
          <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
            ...
            <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="testimonial text-center slider-item">
                <div class="author-image mb-3">
                  <img src="homepage_assets/images/person_1.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
                </div>
                <blockquote>
              ...
              <div class="testimonial text-center slider-item">
                <div class="author-image mb-3">
                  <img src="homepage_assets/images/person_2.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
                </div>
                <blockquote>
                  <p>&ldquo;Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.&rdquo;</p>
                </blockquote>
              ...
              <div class="testimonial text-center slider-item">
                <div class="author-image mb-3">
                  <img src="homepage_assets/images/person_3.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
                </div>
                <blockquote>
      ...
      <section class="section bg-image overlay" style="background-image: url('homepage_assets/images/hero_4.jpg');">
        <div class="container" >
          <div class="row align-items-center">
