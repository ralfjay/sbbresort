    ...
    <!-- END nav -->
                ...
                <div class="row">
                  <div class="col-md-4 mb-3 mb-lg-0 col-lg-3">
                    ...
                    <div class="field-icon-wrap">
                      ...
                      <input type="text" id="checkin" style="text-align: center; background-color: #fff!important;" name="checkin" value="<?php echo e($datetomorrow); ?>" class="form-control" readonly>
                    </div>
                  </div>
                  <div class="col-md-4 mb-3 mb-lg-0 col-lg-3">
                    ...
                    <div class="field-icon-wrap">
                      <div class="icon"><span class="icon-calendar"></span></div>
                      <input type="text" id="checkout" style="text-align: center;background-color: #fff!important;" value="<?php echo e($dateNexttomorrow); ?>" name="checkout" class="form-control" readonly>
                    </div>
                  </div>
                  <div class="col-md-4 mb-3 mb-lg-0 col-lg-3">
     ...
     <section class="section blog-post-entry bg-light" id="section-rooms">
        <div class="container">
          ...
          <div class="row">
            <?php $__currentLoopData = $_roomdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roomdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
              <div class="media media-custom d-block mb-4 h-100">
                ...
                <div class="media-body">
                  ...
                  <h2 class="mt-0 mb-3"><a><?php echo e($roomdata->room_name); ?></a></h2>
                  <p><?php echo e($roomdata->description); ?></p>
                  <p>Good for <?php echo e($roomdata->capacity); ?> pax | Max <?php echo e(($roomdata->capacity + $roomdata->extra_mattress)); ?> pax</p>
                  <p>&#8369;<?php echo e($roomdata->rate); ?> / night</p>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-10 ml-auto contact-info">
                ...
                <p><span class="d-block">Contact Numbers:</span>
                  <span class="text-black"> 
                    <?php $__currentLoopData = $resort_contact_number; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php echo e($contact_number->contact_number); ?> <br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </span></p>
                <p><span class="d-block">Email:</span> <span class="text-black"> <?php $__currentLoopData = $resort_email; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($email->email); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></span></p>
              </div>
            </div>
          </div>
        </div>
