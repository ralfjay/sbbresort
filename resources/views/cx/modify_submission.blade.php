...
<title>Modify Submission - Sigayan Bay Beach Resort</title>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    ...
                    <li>
                      <a>{{$_reservation_data['newCheckIndateDisplay']}}</a>
                    </li>
                    <li>
                     <strong>Check Out</strong>
                    </li>
                     <li>
                      <a>{{$_reservation_data['newCheckOutdateDisplay']}}</a>
                    </li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    ...
                    <li>
                      <a>{{$_reservation_data['dateDiff']}}</a >
                    </li>
                    <li>
                      <strong>Guest(s)</strong>
                    </li>
                     <li>
                      <a>{{$_reservation_data['newGuest']}}</a>
                    </li>
                  </ul>
                </div>
              </div>
             ...
             <h5 class="card-header">Quotation</h5>
              ...
              <div class="row">
                <div class="col-lg-12 text-center">
                  <ul class="list-unstyled mb-0">
                  @for($i = 1;$i <= $index; $i++)
                    <li>{{$room_qnt[$i].'  '.$room_name[$i]}} &mdash; &#x20B1;{{number_format($tot_rate[$i],2)}}</li>
                  @endfor
                  @if($extra_person > 0)
                    <li>{{$extra_person}} Extra Mattress &mdash; &#x20B1;{{number_format(($extra_person*450),2) }}</li>
                  @endif
                  </ul>
                </div>
              </div>
             ...
             <div class="card-body">
              <div class="row">
                <div class="col-md-12 text-center">
                  <ul class="list-unstyled mb-0">
                    <li>VATable Amount  &mdash; &#x20B1;{{ number_format( ($total_amount - (($total_amount / ( 1 + ($tax[0]->tax / 100))) * ($tax[0]->tax / 100))) ,2) }}
                    </li>
                    <li>
                      <span>VAT({{$tax[0]->tax}}%) &mdash; &#x20B1;{{ number_format( (($total_amount / ( 1 + ($tax[0]->tax / 100))) * ($tax[0]->tax / 100)),2 )  }}</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 text-center">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <h4>&#x20B1; {{number_format($downpayment,2)}}</h4>
                    </li>
                  </ul>
                </div>
              </div>
