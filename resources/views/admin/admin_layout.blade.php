...
<head>
  ...
  @if(Session::get('adx_user_type') == 'admin')
...
font-family: Arial, Helvetica, sans-serif!important;
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{Session::get('adx_user_type')=='admin'?'/admin_dashboard':'staff_dashboard'}}">
        <div class="sidebar-brand-icon rotate-n-15">
          <i class="fas fa-laugh-wink"></i>
        </div>
        <div class="sidebar-brand-text mx-3">{{Session::get('adx_user_type')=='admin'?'SBBR-ADMIN':'SBBR-STAFF'}}</div>
      </a>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="{{Session::get('adx_user_type')=='admin'?'/admin_dashboard':'staff_dashboard'}}">
